<div class="container">
    <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 my-5">
        <div class="col mb-3 content-footer-info">
            ...
            <div class="box">
                <div class="icon-wrap"><img src="{{asset('images/mail.svg')}}" alt="mail"></div>
            ...
            <div class="box">
                <div class="icon-wrap"><img src="{{asset('images/location_on.svg')}}" alt="location"></div>
                <div class="content">
                    <p>{{$settingData['address']}}</p>
                    <p class="tiny-grey">Алматы, Казахстан</p>
                    <div class="address-links">
                        <div class="address-link place-at-center pointer"><img src="{{asset('images/twogis.svg')}}"
                                alt="2gis"><span> 2gis</span></div>
                    </div>
                </div>
            </div>
            @endif
            <p class="text-muted">© 2023-2024 {{$settingData['name_company']}}, ИНН\БИН {{$settingData['iinbin']}}, Все
                права защищены</p>
        </div>
